...
import zhuimengren.zhuimengren.utils.BaseTools;
 ...
 */
public class LoginDialogActivity extends RelativeLayout {
    ...
    public LoginDialogActivity(Context context) {
        super(context);
        init(context);
    }

    public LoginDialogActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LoginDialogActivity(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context) {
        ...
        LoginDialogActivity.this.scrollTo(0, mScreenHeigh);
    ...
    public void show(){
        if(!isShow && !isMoving){
            LoginDialogActivity.this.startMoveAnim(-viewHeight,   viewHeight, mDuration);
            isShow = true;
            Log.d("isShow", "true");
            changed();
        }
    ...
    public void dismiss(){
        if(isShow && !isMoving){
            LoginDialogActivity.this.startMoveAnim(0, -viewHeight, mDuration);
            isShow = false;
            Log.d("isShow", "false");
            changed();
        }

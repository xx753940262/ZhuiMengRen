...
public class SwitchButton extends CompoundButton {
    ...
    public SwitchButton(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTrackDrawable = a.getDrawable(R.styleable.SwitchButton_track1);// 获取配置的开关资源
        ...
        // 为选中情况下的显示文字
        // off
        mThumbTextPadding = a.getDimensionPixelSize(R.styleable.SwitchButton_thumbTextPadding1, 0);// 获取配置的按钮字体大小
        mSwitchMinWidth = a.getDimensionPixelSize(R.styleable.SwitchButton_switchMinWidth1, 0);// 获取配置的最小宽度
        mSwitchPadding = a.getDimensionPixelSize(R.styleable.SwitchButton_switchPadding1, 0);// 获取配置的padding属性

        int appearance = a.getResourceId(R.styleable.SwitchButton_switchTextAppearance1, 0);// 获取配置文件中获取显示字体格式
        // 判断设定格式是否存在，存在的话就赋值
        if (appearance != 0) {
